package com.collagemaker_makeanything.StickerView
...
import com.collagemaker_makeanything.Activity.StickerActivity.Companion.binding
...
class CustomStickerView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    private fun setupListeners() {
        ...
        val stickerContainer: ViewGroup =
            findViewById(R.id.stickerLayoutview) // Replace with your actual container ID
        ...
        deleteButton.setOnClickListener { view ->
            ...
            if (stickerLayout != null) {
                ...
                if (parentViewGroup != null) {
                    ...
                    Log.e(
                        "StickerRemoval",
                        "Parent ViewGroup is null or doesn't contain stickerLayout."
                    )
                }
            } else {
                ...
                MotionEvent.ACTION_MOVE -> {
                    if (isRotating) {
                        ...
                        val currentTouchAngle =
                            getAngleFromPoint(centerX, centerY, event.rawX, event.rawY)
...
//      Dragging logic for the entire com.collagemaker_makeanything.StickerView.CustomStickerView (the whole sticker view moves)
    ...
    private fun copySticker() {
        // Create a new instance of com.collagemaker_makeanything.StickerView.CustomStickerView
    ...
    private fun getAngleFromPoint(
        centerX: Float, centerY: Float, touchX: Float, touchY: Float
    ): Float {
